...
public enum CardType {
    ADD(2), CFORWARD(1), FORWARD(1), ANNOTATE(0), BELL(0), COMMENT(1), DECIMALEXPAND(
            ...
            1), LOADPRIME(1), LSHIFT(0), MOVE(0), MULTIPLY(2), NUMBER(1), PRINT(
            0), CBACKWARD(1), BACKWARD(1), RSHIFT(0), STORE(1), STOREPRIME(1), SUBTRACT(
            ...
            0), WRITEDECIMAL(1), WRITEPICTURE(1), WRITEROWS(0), WRITECOLUMNS(0), NEWLINE(0), LSHIFTN(1), RSHIFTN(1);
