...
public class DefaultHashMap<K, V> extends HashMap<K, V> {
    ...
    private ValueGenerator<K, V> generator;
     ...
     * previously by {@link #setValueGenerator(ValueGenerator)}. If the value
    ...
    public V get(final Object key) {
        ...
        this.put((K) key, this.generator.generate((K) key));
        return this.get(key);
    }
     ...
     */
    public void setValueGenerator(final ValueGenerator<K, V> generator) {
